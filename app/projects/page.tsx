      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredProjects.map((project) => (
            <Card
              key={project.id}
              className="bg-slate-800/50 border-slate-700 hover:border-blue-500/50 transition-all duration-300 group overflow-hidden rounded-md"
            >
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="mb-3 sm:mb-4">
                  ...
                  {project.client && (
                    <p className="text-sm sm:text-base md:text-lg text-blue-400 font-medium mb-2">{project.client}</p>
                  )}
                  <p className="text-sm sm:text-base md:text-lg text-slate-300 line-clamp-3">{project.description}</p>
                </div>
